...
const importHeader = 'import { useCSSModule } from \'@vue/composition-api\';';

const exportHookFunction = componentName => `
export const use${componentName}Style = useCSSModule as (() => ${componentName}Style);
`.trim();
...
const filenameToTypingsFilename = filename => {
  ...
  return path.join(dirName, `${componentName}.style.ts`);
};
